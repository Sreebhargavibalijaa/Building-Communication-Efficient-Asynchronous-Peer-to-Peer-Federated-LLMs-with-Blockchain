...
def load_data_clients(i):
    ...
    tokenized_datasets["train"] = tokenized_datasets["train"].select(range(int(300*i),int(int(300*i)+240 )))
    tokenized_datasets["test"] = tokenized_datasets["test"].select(range((int(300*i)+240 ),int(300*(i+1)) ))
